...
class BankTerminalPaymentIntegrationTest {
    ...
    init {
        ...
        // Allow alcohol sales by default (test cart uses non-alcohol items)
        coEvery { alcoholSalePolicy.checkCanSellAlcohol(any(), any()) } returns AlcoholSaleDecision.Allowed
    }
